...
INSERT INTO `problem` VALUES (NULL, '0', '贪心', '树结构', '简单', '字符串统计', 'Bat是一个淘气的小朋友，有一天他得到了一个字符串，他想统计一下字符串中的小写字母(‘a’-’z’)的个数，快来帮帮他吧。', '输入一个字符串', '输出一个整数，代表小写字母的个数。', 'AabcBB', '3', '字符串中不包含空格、字符串长度<10000', '2017-06-03 20:00:00', '1', '2');
